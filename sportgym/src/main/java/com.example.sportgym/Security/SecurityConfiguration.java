...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
     ...
     * antMatchers().hasRole(): Requiere que los usuarios estén autenticados y tengan un cierto rol para acceder a ciertas URL. Por ejemplo, los usuarios con el rol "USER" pueden acceder a las URL /user/**.
    ...
    private String determineTargetUrl(Authentication authentication) {
        ...
        if (roles.contains("ADMIN")) {
            return "/administrador/inventarioImplementos";
        } else {
            return "/cliente/panelPrincipal";
        }
    }
}
